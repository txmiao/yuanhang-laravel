...
@section('title', '服务保障说明列表')
@section('breadcrumb')
    {!! Breadcrumbs::render('service_tips'); !!}
@endsection
@section('style')
...
@section('content')
            ...
            <div class="panel panel-default" data-sortable-id="table-basic-2">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12">
                            <form action="{{ route('service_tips.index') }}" class="form-inline pull-right">
                                <div class="input-group input-group-sm" style="width: 250px;">
                                    <div class="input-group-btn">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a href="javascript:void(0);" data-value="name">服务名称</a></li>
                                        </ul>
                                    </div>
                    ...
                    <table class="table table-hover">
                        ...
                        @if(count($lists))
                            @foreach($lists as $item)
                                <tr>
                                    ...
                                    <td>{!! $item::$bindTypeText[$item->bind_type] !!}</td>
                                    <td>
                                        <a href="{{ route('service_tips.edit', ['id'=>$item->id]) }}"
                                           data-toggle="modal"
                                           data-target="#modal-default-edit"
                                           class="btn btn-success btn-xs"><i class="fa fa-edit"></i> 编辑</a>
                                        <a href="javascript:void(0);"
                                           data-href="{{ route('service_tips.destroy', ['id'=>$item->id]) }}"
                        ...
                        @else
                            <tr>
                                <td colspan="5" align="center"><i class="fa fa-info-circle"></i>&nbsp;暂无符合条件的记录</td>
                            </tr>
                        @endif
    ...
    <div class="modal fade" id="modal-dialog">
        <div class="modal-dialog">
            <form class="form-horizontal" data-parsley-validate="true" name="demo-form"
                  action="{{ route('service_tips.store') }}" method="post" id="create" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        <h4 class="modal-title">新增服务保障</h4>
                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7 col-sm-7">
                                    <input class="form-control" type="text" id="name" name="name" placeholder="请填写服务名称"
                                           ...
                                           data-parsley-maxlength-message="服务名称最多6个字符"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-7 col-sm-7">
                                    <input type="file" id="icon_upload"
                                           ...
                                           data-parsley-required-message="请上传服务图标"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3"
                                ...
                                <div class="col-md-7 col-sm-7">
                                    <select name="bind_type" id="bind_type" class="form-control">
                                        @foreach(\App\Models\ServiceTip::$bindTypeText as $k => $v)
                                            <option value="{{ $k }}">{{ strip_tags($v) }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7 col-sm-7">
                                    <textarea class="form-control" name="content" id="content" rows="8"
                                              ...
                                              data-parsley-required-message="请填写服务保障内容"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="modal-default-edit">
        <div class="modal-dialog">
            <form class="form-horizontal" action="{{ route('service_tips.update') }}" id="edit" method="post"
