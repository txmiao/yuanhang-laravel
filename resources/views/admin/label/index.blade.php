...
@section('content')
                                ...
                                <div class="input-group input-group-sm" style="width: 250px;">
                                    <div class="input-group-btn">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a href="javascript:void(0);" data-value="name">标签名称</a></li>
                                        </ul>
                                    </div>
                        ...
                        @if(count($lists))
                            @foreach($lists as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->name }}</td>
                                    <td>{!! $item::$useRangeText[$item->use_range] !!}</td>
                                    <td>
                                        <a href="{{ route('label.edit', ['id'=>$item->id]) }}" data-toggle="modal"
    ...
    <div class="modal fade" id="modal-dialog">
        <div class="modal-dialog">
            <form class="form-horizontal" data-parsley-validate="true" name="demo-form"
                  action="{{ route('label.store') }}" method="post" id="create">
                {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7 col-sm-7">
                                    <input class="form-control" type="text" id="name" name="name" placeholder="请填写标签名称"
                                           ...
                                           data-parsley-maxlength-message="标签名称最多6个字符"/>
                                </div>
                            </div>
                            <div class="form-group">
    ...
    <div class="modal fade" id="modal-default-edit">
        <div class="modal-dialog">
            <form class="form-horizontal" action="{{ route('label.update') }}" id="edit" method="post"
