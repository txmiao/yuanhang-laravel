...
@section('title', '退货申请列表')
@section('breadcrumb')
    {!! Breadcrumbs::render('sales_return_records'); !!}
@endsection
@section('style')
...
@section('content')
            ...
            <div class="panel panel-default" data-sortable-id="table-basic-2">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12">
                            <form action="{{ route('sales_return_records.index') }}" class="form-inline pull-right">
                                <!-- 状态 -->
                                <div class="form-group form-group-sm">
                                    <select name="status" class="form-control">
                                        <option value="">请选择状态</option>
                                        @foreach(\App\Models\SalesReturnRecord::$status as $k => $item)
                                            <option value="{{ $k }}"
                        ...
                        @if(count($lists))
                            @foreach($lists as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('sales_return_records.edit', ['id'=>$item->id]) }}"
                                           data-toggle="modal"
    ...
    <div class="modal fade" id="modal-default-edit">
        <div class="modal-dialog">
            <form class="form-horizontal" action="{{ route('sales_return_records.update') }}" id="edit" method="post"
