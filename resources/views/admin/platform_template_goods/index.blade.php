...
@section('title', '平台商品模板库列表')
@section('breadcrumb')
    {!! Breadcrumbs::render('platform_template_goods'); !!}
@endsection
@section('style')
...
@section('content')
            ...
            <div class="panel panel-default" data-sortable-id="table-basic-2">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <form action="{{ route('platform_template_goods.index') }}" class="form-inline pull-right">
    ...
    {{-- <div class="modal modal-message fade" id="modal-dialog">
         <div class="modal-dialog">
             <form class="form-horizontal" data-parsley-validate="true" name="demo-form"
                   action="{{ route('platform_template_goods.store') }}" method="post" id="create" enctype="multipart/form-data">
                 {{ csrf_field() }}
                             ...
                             <div class="form-group">
                                 ...
                                 <div class="col-md-7 col-sm-7">
                                     <input class="form-control" type="text" id="subtitle" name="subtitle"
                                            ...
                                            data-parsley-maxlength-message="商品副标题最多10个字符"/>
                                 </div>
                             </div>
                             <div class="form-group">
    ...
    <div class="modal modal-message fade" id="modal-default-edit">
        <div class="modal-dialog">
            <form class="form-horizontal" data-parsley-validate="true" name="demo-form"
                  action="{{ route('platform_template_goods.update') }}" method="post" id="edit">
                {{ csrf_field() }}
                <div class="modal-content">
