...
@section('title', '平台采购商品列表')
@section('breadcrumb')
    {!! Breadcrumbs::render('platform_purchase_records'); !!}
@endsection
@section('style')
...
@section('content')
            ...
            <div class="panel panel-default" data-sortable-id="table-basic-2">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <form action="{{ route('platform_purchase_records.index') }}"
    ...
    {{-- <div class="modal modal-message fade" id="modal-dialog">
         <div class="modal-dialog">
             <form class="form-horizontal" data-parsley-validate="true" name="demo-form"
                   action="{{ route('platform_purchase_records.store') }}" method="post" id="create"
    ...
    <div class="modal modal-message fade" id="modal-default-edit">
        <div class="modal-dialog">
            <form class="form-horizontal" data-parsley-validate="true" name="demo-form"
                  action="{{ route('platform_purchase_records.update') }}" method="post" id="edit">
                {{ csrf_field() }}
                <div class="modal-content">
