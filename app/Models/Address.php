...
{
    const NOT_DEFAULT = 100;
    const IS_DEFAULT = 101;
     ...
     * @return array
     */
    public function gatherData($user_id, $is_default, $request)
    {
        $province = $request->province;
        $city = $request->city;
        $district = $request->district;
        $full_address = $this->getFullAddress($province, $city, $district);
        ...
        $data['detailed_address'] = $request->detailed_address;
